...
keymaps = {
    ...
    "[normal+insert]": {
        ...
        "<back>": "back",
        "<forward>": "forward",
        "<Alt-o>": "cmd-set-text -s :open",
        "<Alt-Shift-o>": "cmd-set-text -s :open -t",
        "<Alt-s>": "cmd-set-text -s :tab-select",
        "<Alt-h>": then_default("tab-prev"),
        "<Alt-j>": then_default("tab-next"),
        "<Alt-k>": then_default("tab-prev"),
        "<Alt-l>": then_default("tab-next"),
        "<Alt-q>": then_default("tab-close"),
